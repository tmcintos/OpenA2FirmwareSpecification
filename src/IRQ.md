...
**Note (Variant Difference):** In the Original Apple II ROM (OrigF8ROM), the IRQ handler is located at $FA86 rather than $FA40. The Apple II+, IIe, and IIc ROMs standardized on the $FA40 address documented here.
