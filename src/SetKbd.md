...
**Hardware Details:**
This routine internally sets [A2L](#a2l) to $00 and calls [InPort](#inport-fe8b) to configure the input hooks. The effect is to reset standard input to ROM-based keyboard input.
