...
*   **Memory:**
    ...
    *   [CH](#ch) (address $24): Updated by [GETCUR](#getcur2-ccad) and [SETCUR](#setcur-ecfe).
...
*   Calls [GETCUR](#getcur2-ccad) and [SETCUR](#setcur-ecfe) to update cursor positions.
