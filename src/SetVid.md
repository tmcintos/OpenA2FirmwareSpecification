...
**Hardware Details:**
This routine internally sets [A2L](#a2l) to $00 and calls [OutPort](#outport-fe95) to configure the output hooks. The effect is to reset standard output to ROM-based screen display.
